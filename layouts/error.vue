  ...
  <div v-if="error.statusCode === 404" class="error404-holder">
    <div class="max-w-screen-xl flex-grow mx-auto">
      <div class="flex items-center justify-center">
        <div class="error-text lg:w-1/4 offset-lg-1 text-center">
          <h1>404</h1>
          <p>
            The page you were looking for couldn't be found. The page could be
            removed or you misspelled the word while searching for it.
          </p>
          <NuxtLink to="/" class="button shadow small light-blue soma-link mt-4"
            ><span>Go Back</span></NuxtLink
          >
        </div>
        <div class="waves lg:w-1/2 offset-lg-1">
          <svg
            version="1.1"
...
<script>
// import ErrorWaves from '~/assets/images/ErrorWaves.svg'
export default {
  // components: {
  //   ErrorWaves
  // },
